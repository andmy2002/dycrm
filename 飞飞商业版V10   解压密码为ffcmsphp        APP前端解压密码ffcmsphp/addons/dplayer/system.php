      ...
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            <td>名称</td>
            <td>
              <a href="https://www.5alen.com" target="_blank">Dplayer播放器</a></td>
            <td>1. PHP版本≥5.6</td></tr>
          <tr>
            <td>作者</td>
            <td>
              <a href="http://www.miaopon.com" target="_blank">喵哣影视网</a></td>
            <td>2. 唯一官方网站，其他网站购买到本源码均为二次倒卖！</td></tr>
          <tr>
            <td>官方网站</td>
            <td>
              <a href="http://www.miaopon.com" target="_blank">http://www.miaopon.com</a></td>
            <td>3. 不支持IE8及以下浏览器，采用HLS流媒体播放m3u8,mp4格式视频，无需flash插件</td></tr>
          <tr>
            <td style="color:red;">使用教程</td>
            <td>
              <a href="" style="color:blue;" target="_blank">购买用户进售后群</a></td>
          ...
          <tr>
            <td colspan="3" style="color:red;">可调用接口：http://<?php echo $_SERVER['HTTP_HOST'];?>/addons/dplayer/?url=</td></tr>			
