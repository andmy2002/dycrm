...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onMouseDown(e) {
            ...
            switch (e_button(e)) {
                case 3:
                    if (gecko && !feifeicms) onContextMenu(e);
                    return;
                case 2:
        ...
        function onKeyDown(e) {
            ...
            if (window.opera) {
                ...
                if (!handled && (feifeicms ? e.metaKey : e.ctrlKey) && e.keyCode == 88)
                    replaceSelection("");
            }
        }
    ...
    var feifeicms = /Feifei/.test(navigator.platform);
    ...
    keyMap.feifeicmsDefault = {
        "Cmd-A": "selectAll", "Cmd-D": "deleteLine", "Cmd-Z": "undo", "Shift-Cmd-Z": "redo", "Cmd-Y": "redo",
        "Cmd-Up": "goDocStart", "Cmd-End": "goDocEnd", "Cmd-Down": "goDocEnd", "Alt-Left": "goWordLeft",
        "Alt-Right": "goWordRight", "Cmd-Left": "goLineStart", "Cmd-Right": "goLineEnd", "Alt-Backspace": "delWordLeft",
        "Ctrl-Alt-Backspace": "delWordRight", "Alt-Delete": "delWordRight", "Cmd-S": "save", "Cmd-F": "find",
        "Cmd-G": "findNext", "Shift-Cmd-G": "findPrev", "Cmd-Alt-F": "replace", "Shift-Cmd-Alt-F": "replaceAll",
        fallthrough: ["basic", "efeifeicmssy"]
    };
    keyMap["default"] = feifeicms ? keyMap.feifeicmsDefault : keyMap.pcDefault;
    keyMap.efeifeicmssy = {
