...
class Provide extends Base
{
    ...
    public function vod_json($res)
    {
        ...
        foreach($res['list'] as $k=>&$v){
            ...
            if(substr($v["vod_pic"],0,4)=="feifeicms:"){
                $v["vod_pic"] = str_replace('feifeicms:','http:',$v["vod_pic"]);
            }
    ...
    public function art()
    {
        ...
        if(empty($html) || $cache_time==0) {
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                if (substr($v["art_pic"], 0, 4) == "feifeicms:") {
                    $v["art_pic"] = str_replace('feifeicms:', 'http:', $v["art_pic"]);
    ...
    public function actor()
    {
        ...
        if(empty($html) || $cache_time==0) {
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                if (substr($v["actor_pic"], 0, 4) == "feifeicms:") {
                    $v["actor_pic"] = str_replace('feifeicms:', 'http:', $v["actor_pic"]);
    ...
    public function role()
    {
        ...
        if(empty($html) || $cache_time==0) {
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                unset($v['data']);
                if (substr($v["role_pic"], 0, 4) == "feifeicms:") {
                    $v["role_pic"] = str_replace('feifeicms:', 'http:', $v["role_pic"]);
    ...
    public function website()
    {
        ...
        if(empty($html) || $cache_time==0) {
            ...
            foreach ($res['list'] as $k => &$v) {
                ...
                if (substr($v["website_pic"], 0, 4) == "feifeicms:") {
                    $v["website_pic"] = str_replace('feifeicms:', 'http:', $v["website_pic"]);
