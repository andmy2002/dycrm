-- ----------------------------
-- Table structure for ffcms_actor
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_actor`;
CREATE TABLE `ffcms_actor` (
...
-- ----------------------------
-- Table structure for ffcms_admin
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_admin`;
CREATE TABLE `ffcms_admin` (
...
-- ----------------------------
-- Table structure for ffcms_art
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_art`;
CREATE TABLE `ffcms_art` (
...
-- ----------------------------
-- Table structure for ffcms_card
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_card`;
CREATE TABLE `ffcms_card` (
...
-- ----------------------------
-- Table structure for ffcms_cash
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_cash`;
CREATE TABLE `ffcms_cash` (
...
-- ----------------------------
-- Table structure for ffcms_cj_content
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_cj_content`;
CREATE TABLE `ffcms_cj_content` (
...
-- ----------------------------
-- Table structure for ffcms_cj_history
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_cj_history`;
CREATE TABLE `ffcms_cj_history` (
...
-- ----------------------------
-- Table structure for ffcms_cj_node
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_cj_node`;
CREATE TABLE `ffcms_cj_node` (
...
-- ----------------------------
-- Table structure for ffcms_collect
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_collect`;
CREATE TABLE `ffcms_collect` (
...
-- ----------------------------
-- Table structure for ffcms_comment
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_comment`;
CREATE TABLE `ffcms_comment` (
...
-- ----------------------------
-- Table structure for ffcms_gbook
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_gbook`;
CREATE TABLE `ffcms_gbook` (
...
-- ----------------------------
-- Table structure for ffcms_group
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_group`;
CREATE TABLE `ffcms_group` (
...
-- ----------------------------
-- Table structure for ffcms_link
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_link`;
CREATE TABLE `ffcms_link` (
...
-- ----------------------------
-- Table structure for ffcms_msg
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_msg`;
CREATE TABLE `ffcms_msg` (
...
-- ----------------------------
-- Table structure for ffcms_order
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_order`;
CREATE TABLE `ffcms_order` (
...
-- ----------------------------
-- Table structure for ffcms_plog
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_plog`;
CREATE TABLE `ffcms_plog` (
...
-- ----------------------------
-- Table structure for ffcms_role
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_role`;
CREATE TABLE `ffcms_role` (
...
-- ----------------------------
-- Table structure for ffcms_topic
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_topic`;
CREATE TABLE `ffcms_topic` (
...
-- ----------------------------
-- Table structure for ffcms_type
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_type`;
CREATE TABLE `ffcms_type` (
...
-- ----------------------------
-- Table structure for ffcms_ulog
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_ulog`;
CREATE TABLE `ffcms_ulog` (
...
-- ----------------------------
-- Table structure for ffcms_user
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_user`;
CREATE TABLE `ffcms_user` (
...
-- ----------------------------
-- Table structure for ffcms_visit
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_visit`;
CREATE TABLE `ffcms_visit` (
...
-- ----------------------------
-- Table structure for ffcms_vod
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_vod`;
CREATE TABLE `ffcms_vod` (
...
-- ----------------------------
-- Table structure for ffcms_website
-- ----------------------------
DROP TABLE IF EXISTS `ffcms_website`;
CREATE TABLE `ffcms_website` (
