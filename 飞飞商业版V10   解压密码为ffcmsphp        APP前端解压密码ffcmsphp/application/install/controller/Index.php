...
class Index extends Controller
{
    ...
    private function step3()
    {
        ...
        $install_dir = ffcms_substring($install_dir, strripos($install_dir, "/")+1);
    ...
    private function step5()
    {
        ...
        $config_new['interface']['pass'] = ffcms_get_rndstr(16);
        ...
        if (file_exists($sql_file)) {
            ...
            $sql_list = ffcms_parse_sql($sql, 0, ['ffcms_' => $config['prefix']]);
            if ($sql_list) {
        ...
        return $this->success('系统安装成功，欢迎您使用飞飞CMS系统建站', $root_dir.'admin.php');
    }
