...
class User extends Base
{
    ...
    public function login($param)
    {
        ...
        cookie('user_portrait', ffcms_get_user_portrait($row['user_id']),['expire'=>2592000] );
    ...
    public function send_msg($param)
    {
        ...
        if($param['ac']=='email'){
            ...
            $res_send = ffcms_send_mail($to, $sign.$title, $msg);
            if($res_send){
                $r=1;
            }
        }
    ...
    public function visit($param)
    {
        ...
        $data['visit_ly'] = htmlspecialchars(ffcms_get_refer());
