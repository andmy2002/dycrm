...
class Index extends Base
{
    ...
    {
        $menus = @include FFCMS_ADMIN_COMM . 'auth.php';
        ...
        $quickmenu = ffcms_read_file( APP_PATH.'data/config/quickmenu.txt');
        if(!empty($quickmenu)){
    ...
    {
        $param = input();
        $res = ffcms_check_back_link($param['url']);
        return json($res);
    }
