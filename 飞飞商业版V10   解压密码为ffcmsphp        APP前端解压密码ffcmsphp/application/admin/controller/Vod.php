...
class Vod extends Base
{
    ...
    public function data()
    {
        ...
        $player_list = ffcms_multisort($player_list,'sort',SORT_DESC,'status','1');
        $downer_list = ffcms_multisort($downer_list,'sort',SORT_DESC,'status','1');
        $server_list = ffcms_multisort($server_list,'sort',SORT_DESC,'status','1');
    ...
    public function batch()
    {
        ...
        if (!empty($param)) {
            ...
            ffcms_echo( "<font color=red>共".$param['total']."条数据需要处理，每页".$param['limit']."条，共".$param['page_count']."页，正在处理第".$param['page']."页数据</font>");
