...
return array(
    ...
    '1' => array('name' => '首页', 'icon' => 'xe625', 'sub' => array(
        '11' => array("show"=>1,"name" => '管理首页页面', 'controller' => 'index', 'action' => 'welcome'),
        '12' => array("show"=>1,"name" => '自定义菜单配置', 'controller' => 'index', 'action' => 'quickmenu'),

        '1002' => array("show"=>0,"name" => '一键清理缓存', 'controller' => 'index', 'action' => 'clear'),

    )),

    '2' => array('name' => '系统配置', 'icon' => 'xe62e', 'sub' => array(
        ...
        '23' => array("show"=>1,"name" => '播放器配置', 'controller' => 'system',			'action' => 'configplay'),
        '212' => array("show"=>1,"name" => '评论留言配置', 'controller' => 'system',			'action' => 'configcomment'),
        '25' => array("show"=>0,"name" => '站外入库配置', 'controller' => 'system',			'action' => 'configinterface'),
        '26' => array("show"=>0,"name" => '开放API配置', 'controller' => 'system',			'action' => 'configapi'),
        ...
        '36' => array("show"=>1,'name' => '附件文件管理', 'controller' => 'images',		'action' => 'index'),
    ...
    '3' => array('name' => '分类/专题', 'icon' => 'xe64b', 'sub' => array(
        '31' => array("show"=>1,'name' => '分类信息管理', 'controller' => 'type',		'action' => 'index'),

        '3101' => array("show"=>1,'name' => '添加分类信息', 'controller' => 'type',		'action' => 'info'),
        '32' => array("show"=>1,'name' => '专题信息管理', 'controller' => 'topic',		'action' => 'data'),
        '3201' => array("show"=>1,'name' => '添加专题信息', 'controller' => 'topic',		'action' => 'info'),
    ...
    '4' => array('name' => '视频管理', 'icon' => 'xe639', 'sub' => array(
        

        '44' => array("show"=>1,'name' => '视频数据信息', 'controller' => 'vod',		'action' => 'data'),
        ...
        '45' => array("show"=>1,'name' => '添加视频信息', 'controller' => 'vod',		'action' => 'info'),
		'495' => array("show"=>0,'name' => '明星演员库', 'controller' => 'actor',		'action' => 'data', 'param'=>''),
		'41' => array("show"=>0,'name' => '服务器组', 'controller' => 'vodserver',		'action' => 'index'),
        ...
        '42' => array("show"=>1,'name' => '系统播放器', 'controller' => 'vodplayer',		'action' => 'index'),
        ...
        '43' => array("show"=>1,'name' => '系统下载器', 'controller' => 'voddowner',		'action' => 'index'),
        ...
        '496' => array("show"=>1,'name' => '角色信息库', 'controller' => 'role',		'action' => 'data', 'param'=>''),
    ...
    '5' => array('name' => '资讯', 'icon' => 'xe616', 'sub' => array(

        '51' => array("show"=>1,'name' => '资讯数据管理', 'controller' => 'art',		'action' => 'data'),

        '52' => array("show"=>1,'name' => '添加资讯信息', 'controller' => 'art',		'action' => 'info'),
        '53' => array("show"=>1,'name' => '已锁定的资讯', 'controller' => 'art',		'action' => 'data','param'=>'lock=1'),
        '54' => array("show"=>1,'name' => '未审核的资讯', 'controller' => 'art',		'action' => 'data','param'=>'status=0'),

        '59' => array("show"=>1,'name' => '批量操作资讯', 'controller' => 'art',		'action' => 'batch'),
        '591' => array("show"=>1,'name' => '重名资讯数据', 'controller' => 'art',		'action' => 'data', 'param'=>'repeat=1'),
    )),

    '6' => array('name' => '用户运营', 'icon' => 'xe62c', 'sub' => array(
        '61' => array("show"=>1,'name' => '管理员信息', 'controller' => 'admin',		'action' => 'index'),
        ...
        '62' => array("show"=>1,'name' => '会员组信息', 'controller' => 'group',		'action' => 'index'),
        ...
        '63' => array("show"=>1,'name' => '会员信息', 'controller' => 'user',		'action' => 'data'),
    ...
    '7' => array('name' => '风格', 'icon' => 'xe72d', 'sub' => array(
        '71' => array("show"=>1,'name' => '模板管理', 'controller' => 'Tpl',		'action' => 'index'),
        '7101' => array("show"=>0,'name' => '模板信息维护', 'controller' => 'Tpl',		'action' => 'info'),
        '7102' => array("show"=>0,'name' => '--模板删除', 'controller' => 'Tpl',		'action' => 'del'),

        '72' => array("show"=>1,'name' => '广告管理', 'controller' => 'Tpl',		'action' => 'ads',  'param'=>''),
        '73' => array("show"=>1,'name' => '标签向导', 'controller' => 'Tpl',		'action' => 'wizard'),
    ...
    '8' => array('name' => '伪/静态', 'icon' => 'xe63e', 'sub' => array(
    ...
    '9' => array('name' => '采集', 'icon' => 'xe727', 'sub' => array(
        ...
        '93' => array("show"=>1,'name' => '采集资源库', 'controller' => 'collect',		'action' => 'index'),
    ...
    '11' => array('name' => '推送', 'icon' => 'xe621', 'sub' => array(
        ...
        '11201' => array("show"=>1,'name' => '百度主动推送', 'controller' => 'urlsend',		'action' => 'baidu_push'),
        '11202' => array("show"=>1,'name' => '百度熊掌推送', 'controller' => 'urlsend',		'action' => 'baidu_bear'),
    )),
 '12' => array('name' =>'网址', 'icon' => 'xe616', 'sub' => array(

        '121' => array("show"=>0,'name' => '网址数据', 'controller' => 'website',		'action' => 'data'),
        ...
        '122' => array("show"=>0,'name' => '添加网址', 'controller' => 'website',		'action' => 'info'),
        '123' => array("show"=>0,'name' => '已锁定网址', 'controller' => 'website',		'action' => 'data','param'=>'lock=1'),
        '124' => array("show"=>0,'name' => '未审核网址', 'controller' => 'website',		'action' => 'data','param'=>'status=0'),

        '129' => array("show"=>0,'name' => '批量操作网址', 'controller' => 'website',		'action' => 'batch'),
        '1291' => array("show"=>0,'name' => '重名网址数据', 'controller' => 'website',		'action' => 'data', 'param'=>'repeat=1'),
    )),
