...
class User extends Base
{
    ...
    public function portrait()
    {
        ...
        try {
            ...
            return json(['code' => 1, 'msg' => 'ok', 'file' =>  '' . FFCMS_PATH . $new_file . '?' . mt_rand(1, 9999)]);
        } catch (\Exception $e) {
    ...
    public function buy()
    {
        ...
        if (Request()->isPost()) {
            ...
            if ($flag == 'card') {
                ...
                $data = [];
                $data['user_id'] = $GLOBALS['user']['user_id'];
                $data['order_code'] = 'PAY' . ffcms_get_uniqid_code();
    ...
    public function plays()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/plays', ['page' => 'PAGELINK']));
    ...
    public function downs()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/downs', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
    ...
    public function favs()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/favs', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
    ...
    public function ulog()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/ulog', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
    ...
    public function plog()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/plog', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
    ...
    public function cash()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/cash', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
    ...
    public function orders()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/orders', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
        $this->assign('param',$param);
        $this->assign('list', $res['list']);
    ...
    public function cards()
    {
        ...
        $pages = ffcms_page_param($res['total'], $param['limit'], $param['page'], url('user/cards', ['page' => 'PAGELINK']));
        $this->assign('__PAGING__', $pages);
        $this->assign('param',$param);
        $this->assign('list', $res['list']);
