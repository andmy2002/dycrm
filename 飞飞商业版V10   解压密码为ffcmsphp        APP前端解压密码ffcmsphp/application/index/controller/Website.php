...
class Website extends Base
{
    ...
    public function type()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('website',$info['type_tpl'],'type') );
    }

    public function show()
    {
        $info = $this->label_type();
        return $this->label_fetch( ffcms_tpl_fetch('website',$info['type_tpl_list'],'show') );
    }
    ...
    public function detail()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('website',$info['website_tpl'],'detail') );
    }
