...
class Vod extends Base
{
    ...
    public function type()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('vod',$info['type_tpl'],'type') );
    }

    public function show()
    {
        $info = $this->label_type();
        return $this->label_fetch( ffcms_tpl_fetch('vod',$info['type_tpl_list'],'show') );
    }
    ...
    public function detail()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('vod',$info['vod_tpl'],'detail') );
    }
    ...
    public function play()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('vod',$info['vod_tpl_play'],'play') );
    }
    ...
    public function down()
    {
        ...
        return $this->label_fetch( ffcms_tpl_fetch('vod',$info['vod_tpl_down'],'down') );
    }
